...
; developed by Bo Brant�n <bosse@accum.se> in 2020 to help beta testing.
;
...
DirText "This is a release of the ${PROJECTNAME} project from Bo Brant�n to test the new ext4 features metadata checksums and 64-bit block numbers. You may choose the install directory:"
...
; CI build overrides these by passing /D flags to makensis.
; Fallback defaults are for local development with VS2022 Community edition.
!ifndef MSVPATH_X86
